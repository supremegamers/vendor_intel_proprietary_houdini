...
`houdini` version: 13.0.1_y.Tencent_AoW_Com2.5b 

`houdini64` version: 13.0.1_z.Tencent_AoW_Com2.5b

Android image fingerprint: intel/caas/caas:13/TQ2A.230505.002/ubuntu01152050:user/release-keys
