...
`houdini` version = 14.0.0_y.GoogleGame_com1.2

`houdini64` version = 14.0.0_z.GoogleGame_com1.2

HPE Android image fingerprint : google/kiwi_x86_64/vsoc_kiwi_x86_64:14/UKW1.251130.001/14513382:user/release-keys
